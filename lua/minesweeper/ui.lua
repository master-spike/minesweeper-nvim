...
function M.setup_highlights()
	...
	set_hl(0, "MinesweeperEmpty", { default = true, fg = "#7f848e" })
	set_hl(0, "MinesweeperCursor", { default = true, fg = "#61afef", bold = true })
	set_hl(0, "MinesweeperNumber1", { default = true, fg = "#61afef", bold = true })
	set_hl(0, "MinesweeperNumber2", { default = true, fg = "#98c379", bold = true })
	set_hl(0, "MinesweeperNumber3", { default = true, fg = "#e06c75", bold = true })
	set_hl(0, "MinesweeperNumber4", { default = true, fg = "#c678dd", bold = true })
	set_hl(0, "MinesweeperNumber5", { default = true, fg = "#be5046", bold = true })
	set_hl(0, "MinesweeperNumber6", { default = true, fg = "#56b6c2", bold = true })
	set_hl(0, "MinesweeperNumber7", { default = true, fg = "#abb2bf", bold = true })
	set_hl(0, "MinesweeperNumber8", { default = true, fg = "#ffffff", bold = true })
